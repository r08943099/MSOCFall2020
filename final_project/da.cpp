...
//#pragma HLS unroll
            ...
            execute_replica <10>(&replica[10]);
            calculate_energy<10>(&replica[10]);
            execute_replica <11>(&replica[11]);
            calculate_energy<11>(&replica[11]);
            execute_replica <12>(&replica[12]);
            calculate_energy<12>(&replica[12]);
            execute_replica <13>(&replica[13]);
            calculate_energy<13>(&replica[13]);
            execute_replica <14>(&replica[14]);
            calculate_energy<14>(&replica[14]);
            execute_replica <15>(&replica[15]);
            calculate_energy<15>(&replica[15]);
            execute_replica <16>(&replica[16]);
            calculate_energy<16>(&replica[16]);
            execute_replica <17>(&replica[17]);
            calculate_energy<17>(&replica[17]);
            execute_replica <18>(&replica[18]);
            calculate_energy<18>(&replica[18]);
            execute_replica <19>(&replica[19]);
            calculate_energy<19>(&replica[19]);            
